...
export default function AddSeller() {
  ...
  return (
    <div className="container mx-auto p-4 max-w-4xl">
      ...
      >
        <span className="relative inline-block pb-2 border-b-4 border-gray-900">Add New Seller</span>
      </motion.h3>
      ...
      >
        <div className="bg-gray-900 -m-8 mb-6 p-6 rounded-t-xl">
          <h4 className="text-xl font-semibold text-white">Seller Registration Form</h4>
          <p className="text-gray-300 text-sm">Create a new seller account in the system</p>
        </div>
        ...
        >
            ...
            {[
              ...
              >
                ...
                <input
                  ...
                  className="w-full p-3 bg-gray-50 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-all duration-200"
                  required
                />
              </motion.div>
            ))}
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className={`bg-gray-900 text-white px-6 py-3 rounded-md shadow-md hover:bg-black focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-offset-2 transition-all duration-200 transform ${isSubmitting ? 'opacity-75' : ''}`}
            >
              {isSubmitting ? (
