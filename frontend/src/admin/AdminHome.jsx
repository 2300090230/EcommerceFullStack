  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <button
          className="px-4 py-2 bg-gray-900 text-white rounded-md text-sm font-medium hover:bg-black transition-colors flex items-center"
        >
        ...
        <>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <DashboardCard
              ...
              icon={<UsersIcon className="h-8 w-8 text-gray-900" />}
