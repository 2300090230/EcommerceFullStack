...
export default function SellersLobby() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      >
        <span className="text-gray-900 relative inline-block border-b-4 border-gray-900 pb-1">
      ...
      >
        <div className="bg-gray-900 px-6 py-4">
          <h4 className="text-xl font-semibold text-white">Seller Applications</h4>
          <p className="text-gray-300 text-sm">Approve or reject seller account applications</p>
        </div>
              ...
              {loading ? (
                ...
                sellers.map((seller, index) => (
                  <tr 
                    key={seller.id} 
                    data-id={seller.id}
                    className="hover:bg-gray-100 transition-colors table-row"
                        ...
                        {seller.status === "Pending" && (
                          <>
                            <button 
                              ...
                              className="relative overflow-hidden px-3 py-1.5 bg-gray-900 text-white rounded transition-all duration-300 ease-in-out hover:bg-black focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-opacity-50 flex items-center"
                            >
