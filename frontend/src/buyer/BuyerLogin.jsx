    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100 px-4 sm:px-6 lg:px-8">
      <div className="bg-white p-6 sm:p-8 rounded-lg shadow-md w-full max-w-sm sm:max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-3 py-2 sm:py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-900"
              required
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-gray-900 text-white py-2 sm:py-3 rounded-md hover:bg-black transition duration-200 mb-4"
          >
            Sign In
          </button>
          ...
          <div className="text-center">
            <button
              type="button"
              onClick={clearForm}
              className="text-gray-900 hover:underline mb-4"
            >
              Clear Form
            </button>
          </div>
        ...
        <div className="text-center mt-4">
          ...
          <Link
            to="/forgotpassword"
            className="text-gray-900 hover:underline block mt-2"
          >
