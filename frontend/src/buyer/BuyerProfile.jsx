...
export default function BuyerProfile() {
  ...
  const getAddressIcon = (addressType) => {
    switch (addressType?.toLowerCase()) {
      ...
      default:
        return <FaMapMarkerAlt className="text-gray-900" />;
    }
  };
      ...
      {pageLoading ? (
        ...
        <div className="bg-white rounded-xl shadow-xl overflow-hidden animate-pulse">
          <div className="bg-gradient-to-r from-blue-500 to-blue-700 px-6 py-4">
            <div className="h-6 bg-gray-300 bg-opacity-50 rounded w-1/4 mb-2 skeleton-loading"></div>
            <div className="h-4 bg-gray-300 bg-opacity-50 rounded w-2/4 skeleton-loading"></div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-xl overflow-hidden hover:shadow-2xl transition duration-300">
          <div className="bg-gradient-to-r from-blue-500 to-blue-700 px-6 py-4">
            ...
            <p className="text-gray-300 text-sm">Manage your account information and delivery addresses</p>
          </div>
                  ...
                  <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="w-full md:w-2/3 space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            className="w-full px-4 py-2.5 border border-gray-300 rounded-md focus:ring-gray-900 focus:border-blue-500"
                      ...
                      <div className="flex justify-between pt-4">
                        ...
                        <button
                          type="submit"
                          className="px-6 py-2.5 bg-gray-900 text-white font-medium rounded-md hover:bg-black transition flex items-center"
                          disabled={isLoading}
                        >
                          {isLoading ? (
                            <>
                    ...
                    <div className="w-full md:w-1/3 flex flex-col items-center justify-start p-4 border-2 border-dashed border-gray-300 rounded-lg">
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-sm text-gray-500 flex items-center justify-center">
                          <FaMapMarkerAlt className="mr-1 text-gray-900" /> {buyer.address || "Address not set"}
                        </div>
                      </div>
                    </div>
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="bg-gray-50 p-4 rounded-lg">
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <button 
                                  onClick={() => setActiveTab('addresses')}
                                  className="text-gray-900 text-sm font-medium hover:text-black flex items-center"
                                >
            ...
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                ...
                <button 
                  ...
                  className="px-4 py-2 bg-gray-900 text-white rounded-md hover:bg-black transition flex items-center text-sm"
                >
              ...
              {addressLoading ? (
                ...
                <div className="text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                  ...
                  <button 
                    onClick={handleAddAddressClick}
                    className="px-6 py-2.5 bg-gray-900 text-white rounded-md hover:bg-black transition flex items-center mx-auto"
                  >
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                          {!address.isDefault && (
                            <button
                              ...
                              className="text-sm text-gray-900 hover:text-black p-1.5 hover:bg-gray-100 rounded-md transition flex items-center"
                          ...
                          <button 
                            ...
                            className="text-sm text-gray-600 hover:text-gray-900 p-1.5 hover:bg-gray-100 rounded-md transition"
                            title="Edit"
                          >
                  ...
                  >
                    <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center mb-3">
                      <FaPlus className="h-5 w-5 text-gray-900" />
                    </div>
          ...
          <div className="bg-white rounded-lg max-w-lg w-full mx-auto animate-slideDown overflow-hidden">
            ...
            <form onSubmit={handleSaveAddress} className="p-6">
              <div className="space-y-5">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-900"
                    required
                  >
              ...
              <div className="mt-6 flex justify-end gap-4">
                ...
                <button
                  type="submit"
                  className="px-5 py-2.5 bg-gray-900 text-white rounded-md hover:bg-black focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-opacity-50 font-medium flex items-center"
