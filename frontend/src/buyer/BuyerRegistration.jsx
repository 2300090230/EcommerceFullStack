      ...
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-1 focus:ring-gray-900"
              required
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-gray-900 text-white py-2 rounded-md hover:bg-gray-900 transition"
          >
            Register
          </button>
          ...
          <button 
            type="button" 
            onClick={clearForm}
            className="block w-full text-center text-gray-900 mt-3 hover:underline"
          >
            Clear Form
          </button>
        </form>
        ...
        <div className="mt-4 text-center">
          <p className="text-gray-700">
            ...
            <Link to="/buyerlogin" className="text-gray-900 hover:underline ml-1">Sign In</Link>
          </p>
        </div>
      </div>
    </div>
