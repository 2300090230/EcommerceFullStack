      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between mb-4">
          <button 
            ...
            className="flex items-center text-gray-900 hover:text-black font-medium transition-colors"
          >
        ...
        {loadingAddresses ? (
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6 text-center">
            ...
            <button 
              ...
              className="text-gray-900 hover:text-black font-medium inline-flex items-center"
            >
          ...
          <>
            <div className="block md:hidden space-y-4">
              {addresses.map(address => (
                <div 
                  key={address.id} 
                  className={`relative p-4 rounded-lg border ${selectedAddressId === address.id ? 'border-blue-500 bg-gray-100 shadow-lg' : 'border-gray-200 bg-white shadow-sm'} 
                ...
                >
                  <div className="flex items-start space-x-3">
                    <div className={`h-5 w-5 rounded-full border flex items-center justify-center 
                      ${selectedAddressId === address.id ? 'border-blue-500 bg-gray-900' : 'border-gray-400'}`}>
            ...
            <div 
              ...
              onClick={() => setShowAddressModal(true)}
            >
              <div className="flex items-center text-gray-900 hover:text-black font-medium">
                <FaPlus className="mr-2" />
                Add New Address
              </div>
            </div>
        ...
        {addresses.length > 0 && (
          <div className="flex justify-end mt-6">
            <button
              ...
              className={`bg-gray-900 hover:bg-black text-white py-2 px-4 rounded-lg 
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-md border border-gray-100 p-6 transform transition-all duration-300 hover:shadow-lg">
          ...
          <div className="pt-4 border-t border-gray-200">
            ...
            <div className="flex justify-between items-center mt-3 pt-3 border-t border-gray-200">
              ...
              <span className="text-xl font-bold text-gray-900">₹{cartItems.reduce((total, item) => total + (Number(item.product.cost) * item.quantity), 0).toFixed(2)}</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md border border-gray-100 p-6 transform transition-all duration-300 hover:shadow-lg">
          ...
          <button 
            ...
            className="w-full bg-gray-900 text-white py-3 px-5 rounded-lg hover:bg-black transition-colors font-medium shadow-md hover:shadow-lg transform hover:-translate-y-1 duration-300">
            Place Order
          </button>
        </div>
      </div>
      ...
      return (
        <div className="flex flex-col items-center justify-center p-8 bg-white rounded-lg shadow-md border border-gray-200 transform transition-all duration-300 hover:shadow-lg">
          <div className="bg-gray-100 p-6 rounded-full mb-4">
            <FaShoppingCart className="text-gray-900 text-4xl" />
          </div>
          ...
          <Link to="/" 
            className="bg-gray-900 hover:bg-black text-white py-2 px-6 rounded-lg font-medium flex items-center shadow-md hover:shadow-lg transform hover:-translate-y-1 duration-300">
            <FaArrowLeft className="mr-2" />
            Continue Shopping
          </Link>
        </div>
              ...
              <div key={item.id} className="p-4 border-b border-gray-100 last:border-0">
                <div className="flex gap-4">
                  ...
                  <div className="flex-grow">
                    ...
                    <p className="text-gray-900 font-medium mb-2">₹{item.product.cost}</p>
        ...
        <div className="lg:flex lg:justify-between lg:items-start lg:mt-8">
          <div className="mb-6 lg:mb-0 lg:flex-1 order-2 lg:order-1">
            <div className="flex flex-wrap gap-4 items-center">
              <Link to="/" 
                className="flex items-center text-gray-900 hover:text-black font-medium transition-colors px-5 py-2.5 rounded-lg hover:bg-gray-100 border border-blue-100 shadow-md hover:shadow-lg transform hover:-translate-y-1 duration-300">
                <FaArrowLeft className="mr-2" />
                Continue Shopping
              </Link>
          ...
          <div className="bg-white rounded-lg shadow-md border border-gray-100 p-6 w-full lg:w-96 order-1 lg:order-2 transform transition-all duration-300 hover:shadow-lg">
            ...
            <button 
              ...
              className="w-full mt-6 bg-gray-900 text-white py-3 px-5 rounded-lg hover:bg-black transition-colors font-medium shadow-md hover:shadow-lg transform hover:-translate-y-1 duration-300">
              Proceed to Checkout
            </button>
