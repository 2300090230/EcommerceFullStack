    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded shadow-md">
          ...
          <button 
            onClick={() => navigate(-1)}
            className="mt-4 flex items-center text-gray-900 hover:underline"
          >
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <nav className="flex items-center text-sm text-gray-500 mb-6">
        ...
        <button onClick={() => navigate(`/category/${product.category}`)} className="hover:text-gray-900 transition-colors">{product.category}</button>
        <span className="mx-2">›</span>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <button 
              ...
              className="bg-gray-900 text-white py-3 px-6 rounded-lg hover:bg-black transition-colors font-medium text-lg shadow-md"
            >
              Buy Now
            </button>
            <button 
              onClick={handleAddToCart}
              className="border-2 border-gray-900 text-gray-900 py-3 px-6 rounded-lg hover:bg-gray-100 transition-colors font-medium text-lg flex items-center justify-center"
            >
          ...
          <div className="grid grid-cols-3 gap-4 border-t border-b border-gray-200 py-6">
            <div className="flex flex-col items-center text-center">
              <FaTruck className="text-gray-900 text-2xl mb-2" />
              <span className="text-sm font-medium">Fast Delivery</span>
            </div>
            <div className="flex flex-col items-center text-center">
              <FaShieldAlt className="text-gray-900 text-2xl mb-2" />
              <span className="text-sm font-medium">Secure Payment</span>
            </div>
            <div className="flex flex-col items-center text-center">
              <FaExchangeAlt className="text-gray-900 text-2xl mb-2" />
            ...
            {relatedProducts.map((relatedProduct) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-900 font-bold mt-2">₹{parseFloat(relatedProduct.cost).toLocaleString()}</p>
                </div>
              </div>
            ))}
          </div>
