      ...
      <div className="bg-white p-6 sm:p-8 rounded-lg shadow-md w-full max-w-sm sm:max-w-md">
        ...
        {!token ? (
          <div className="text-center my-6">
            ...
            <Link
              to="/forgotpassword"
              className="block w-full bg-gray-900 text-white py-2.5 rounded-lg font-medium hover:bg-black transition-colors"
            >
              Request New Link
            </Link>
          </div>
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3 py-2.5 pr-10 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-900"
                  required
                  minLength={6}
                />
                <button
        ...
        <div className="text-center mt-4">
          <Link
            to="/buyerlogin"
            className="text-gray-900 hover:text-gray-700 font-medium hover:underline block"
          >
            Back to Sign In
          </Link>
        </div>
