        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-wrap items-center justify-between">
            ...
            <Link to="/" className="flex flex-col items-start space-y-0.5">
              <div className="text-gray-900 font-bold text-2xl">LL-CART</div>
            ...
            <div className="hidden md:block flex-grow max-w-md mx-6">
              <form onSubmit={handleSearch} className="relative">
                <input
                  ...
                  className="w-full border border-gray-300 rounded-lg py-2.5 px-4 pl-12 focus:outline-none focus:ring-2 focus:ring-gray-900"
                  value={searchQuery}
            ...
            <nav className="hidden md:flex items-center space-x-6">
              <Link to="/" className="text-gray-700 hover:text-gray-900 flex items-center font-medium">
                <FaHome className="mr-2" /> Home
              </Link>
              <Link to="/buyerregistration" className="text-gray-700 hover:text-gray-900 flex items-center font-medium">
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {loginDropdownOpen && (
                  <div className="absolute right-0 mt-3 w-52 bg-white rounded-md shadow-lg py-2 z-50 border border-gray-100">
                    <Link to="/buyerlogin" className="block px-5 py-3 hover:bg-gray-100 text-gray-700" onClick={() => setLoginDropdownOpen(false)}>
                      <FaUser className="inline mr-3 text-gray-900" /> Buyer Login
                    </Link>
                    <Link to="/sellerlogin" className="block px-5 py-3 hover:bg-gray-100 text-gray-700" onClick={() => setLoginDropdownOpen(false)}>
                      <FaStore className="inline mr-3 text-gray-900" /> Seller Login
                    </Link>
                    <Link to="/adminlogin" className="block px-5 py-3 hover:bg-gray-100 text-gray-700" onClick={() => setLoginDropdownOpen(false)}>
                      <FaUser className="inline mr-3 text-gray-900" /> Admin Login
                    </Link>
                  </div>
                )}
              </div>
              ...
              <Link
                ...
                className="bg-gray-900 text-white px-5 py-2.5 rounded-lg shadow-md hover:bg-black flex items-center font-medium"
              >
      ...
      <div className={`fixed inset-y-0 right-0 z-50 w-72 bg-white shadow-xl transform ${sidebarOpen ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-300 ease-in-out md:hidden`}>
        ...
        <nav className="p-5">
          <ul className="space-y-5">
            <li>
              <Link to="/" className="flex items-center text-gray-700 hover:text-gray-900" onClick={toggleSidebar}>
                <FaHome className="mr-3 text-gray-900" /> Home
              </Link>
            </li>
            <li>
              <Link to="/buyerregistration" className="flex items-center text-gray-700 hover:text-gray-900" onClick={toggleSidebar}>
                <FaUserPlus className="mr-3 text-gray-900" /> Registration
              </Link>
            </li>
            <li className="border-t border-b py-4">
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/buyerlogin" className="flex items-center text-gray-700 hover:text-gray-900" onClick={toggleSidebar}>
                    <FaUser className="mr-3 text-gray-900" /> Buyer Login
                  </Link>
                </li>
                <li>
                  <Link to="/sellerlogin" className="flex items-center text-gray-700 hover:text-gray-900" onClick={toggleSidebar}>
                    <FaStore className="mr-3 text-gray-900" /> Seller Login
                  </Link>
                </li>
              </ul>
            </li>
            <li>
              <Link to="/sellerregistration" className="bg-gray-900 text-white px-4 py-3 rounded-lg hover:bg-black flex justify-center items-center shadow-md" onClick={toggleSidebar}>
                <FaStore className="mr-2" /> Become a Seller
              </Link>
            </li>
          </ul>
