  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 animate-fadeIn">
      <h3 className="text-3xl font-bold text-center mb-8 relative overflow-hidden">
        <span className="relative z-10 inline-block logo-text after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-full after:h-1 after:bg-gradient-to-r after:from-gray-800 after:to-black after:transform after:transition-all after:duration-300 hover:after:h-2">
          Add Product
        </span>
      </h3>
      ...
      {pageLoading ? (
        ...
        <div className="bg-white rounded-xl shadow-xl overflow-hidden animate-pulse">
          ...
          <div className="bg-gradient-to-r from-gray-800 to-black px-6 py-4">
            <div className="h-6 bg-gray-300 bg-opacity-50 rounded w-1/4 mb-2"></div>
            <div className="h-4 bg-gray-300 bg-opacity-50 rounded w-2/4"></div>
          </div>
          ...
          <div className="p-6">
            ...
            <div className="flex items-center justify-center mt-8">
              <div className="h-12 bg-gradient-to-r from-gray-800 to-black rounded-lg w-40"></div>
            </div>
          </div>
        </div>
      ) : (
        ...
        >
          <div className="bg-gradient-to-r from-gray-800 to-black px-6 py-4">
            <h4 className="text-xl font-semibold text-white">Product Information</h4>
            <p className="text-gray-300 text-sm">Fill in the information below to add a new product</p>
          </div>
          ...
          <form onSubmit={handleSubmit} encType="multipart/form-data" className="p-6">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                ...
                <div className="relative">
                  <select 
                    className="appearance-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-gray-900 block w-full p-3 shadow-sm transition-all duration-300 focus:shadow-md hover:border-gray-600"
                    id="category"
                    name="category" 
                  ...
                  <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 bg-gradient-to-r from-gray-800 to-black h-full rounded-r-lg">
              ...
              >
                ...
                <input 
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-gray-900 block w-full p-3 transition-all duration-300 focus:shadow-md" 
                  id="name"
                  type="text" 
                  name="name" 
                  value={product.name} 
              ...
              >
                ...
                <div className="relative">
                  ...
                  <input 
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-gray-900 block w-full pl-7 p-3 transition-all duration-300 focus:shadow-md" 
                    id="cost"
                    type="number" 
                    step="0.01" 
                    name="cost" 
            ...
            {previewUrl && (
              ...
              >
                ...
                <div className="border-2 border-gray-300 rounded-lg p-2 w-full flex justify-center bg-gray-50">
            ...
            >
              <button 
                className={`relative overflow-hidden px-8 py-3 bg-gradient-to-r from-gray-800 to-black text-white font-medium rounded-lg transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-opacity-50 ${isLoading ? 'opacity-75 cursor-not-allowed' : ''}`} 
                type="submit"
                disabled={isLoading}
              >
