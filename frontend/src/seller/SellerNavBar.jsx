    ...
    return (
        ...
        className={`flex items-center px-6 py-3 text-gray-700 group transition-all duration-200 relative
          ${isActive 
            ? isLogout
              ...
              : 'text-gray-900 bg-gray-100 border-r-4 border-gray-900 font-medium'
            : isLogout
      ...
      >
        <span className={`${isActive 
          ? (isLogout ? 'text-red-600' : 'text-gray-900') 
          : 'text-gray-500 group-hover:text-gray-900'} nav-icon`}
        >
          {icon}
        </span>
    ...
    <div className="flex flex-col md:flex-row h-screen bg-gray-100">
        ...
        <div className="flex items-center justify-between px-4 py-3">
          <div className="flex items-center">
            <button 
              ...
              className="text-gray-500 focus:outline-none mr-4 transform transition-transform duration-300 hover:scale-110 hover:text-gray-900 active:scale-95"
            >
      ...
      >
        ...
        <Link to="/" className="flex flex-col items-center py-6 md:py-8 border-b border-gray-200">
          <div className="text-gray-900 font-bold text-2xl md:text-3xl tracking-wide relative group logo-container">
            <span className="logo-text">LL-CART</span>
        ...
        <div className="hidden md:block bg-white shadow-md">
          <div className="px-6 py-4 flex justify-between items-center">
            <h1 className="text-2xl font-semibold text-gray-800 flex items-center">
              <span className="text-gray-900 mr-2">Seller</span> Dashboard
              <div className="w-2 h-2 bg-green-500 rounded-full ml-3 pulse-dot"></div>
            </h1>
            
            <div className="flex items-center px-4 py-1 bg-gray-100 rounded-full border border-gray-300">
