      ...
      {pageLoading ? (
        ...
        <div className="bg-white rounded-xl shadow-xl overflow-hidden hover:shadow-2xl">
          <div className="bg-gradient-to-r from-blue-500 to-blue-700 px-6 py-4">
            ...
            <p className="text-gray-300 text-sm">Your seller account information</p>
          </div>
          ...
          {isEditing ? (
            <form onSubmit={handleEditSubmit} className="p-6">
                ...
                >
                  ...
                  <div className="w-full">
                    ...
                    <input 
                      ...
                      className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-blue-500 block w-full p-2 text-center transition-all duration-300 focus:shadow-md"
                      required
                    />
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <input 
                      ...
                      onChange={handleEditChange}
                      className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-blue-500 block w-full p-2 transition-all duration-300 focus:shadow-md"
                      required
                    />
                  </div>
              ...
              >
                <button 
                  type="submit" 
                  className="relative overflow-hidden px-6 py-2 bg-gradient-to-r from-blue-500 to-blue-700 text-white font-medium rounded-lg transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-opacity-50"
                  disabled={isLoading}
                >
                ...
                <div className="space-y-4">
                  ...
                  >
                    <div className="flex items-center">
                      <MailIcon className="h-5 w-5 text-gray-900 mr-2" />
                  ...
                  >
                    <div className="flex items-center">
                      <PhoneIcon className="h-5 w-5 text-gray-900 mr-2" />
                  ...
                  >
                    <div className="flex items-center">
                      <LocationMarkerIcon className="h-5 w-5 text-gray-900 mr-2" />
                  ...
                  >
                    <div className="flex items-center">
                      <IdentificationIcon className="h-5 w-5 text-gray-900 mr-2" />
