    ...
    <div className="max-w-2xl mx-auto p-5 bg-white rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex justify-center mt-5">
          <button
            type="submit"
            disabled={loading}
            className="px-6 py-2 bg-gray-900 text-white rounded hover:bg-black focus:outline-none focus:ring-2 focus:ring-gray-900 transition-colors disabled:bg-gray-400"
          >
            {loading ? (
      ...
      <div className="mt-4 text-center text-sm">
        <p>
          ...
          <Link to="/sellerlogin" className="text-gray-900 hover:underline">
            Sign in
          </Link>
        </p>
      </div>
