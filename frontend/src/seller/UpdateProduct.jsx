      ...
      {pageLoading ? (
        ...
        >
          <div className="bg-gradient-to-r from-blue-500 to-blue-700 px-6 py-4">
            ...
            <p className="text-gray-300 text-sm">Update your product information below</p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                ...
                <div className="relative">
                  <select 
                    className="appearance-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-blue-500 block w-full p-3 shadow-sm transition-all duration-300 focus:shadow-md hover:border-blue-400"
                    id="category"
                    name="category" 
              ...
              >
                ...
                <input 
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-blue-500 block w-full p-3 transition-all duration-300 focus:shadow-md" 
                  id="name"
                  type="text" 
                  name="name" 
                  value={product.name} 
              ...
              >
                ...
                <div className="relative">
                  ...
                  <input 
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-900 focus:border-blue-500 block w-full pl-7 p-3 transition-all duration-300 focus:shadow-md" 
                    id="cost"
                    type="number" 
                    step="0.01" 
                    name="cost" 
              ...
              >
                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="productImage">
                  Product Image {!imageChanged && <span className="text-xs text-gray-900">(Current image will be kept unless changed)</span>}
                </label>
