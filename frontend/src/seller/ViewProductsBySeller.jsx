    ...
    <div className="bg-white p-6 rounded-lg shadow-sm">
      <div className="flex flex-col sm:flex-row justify-between items-center mb-8">
        <h2 className="text-2xl font-semibold text-gray-800 mb-4 sm:mb-0">
          My Products {!loading && <span className="text-gray-900">({products.length})</span>}
        </h2>
        <Link
          to="/addproduct"
          className="inline-flex items-center px-4 py-2 bg-gray-900 text-white rounded-md hover:bg-black transition-colors duration-300"
        >
